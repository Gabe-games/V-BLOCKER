...
function beginEncounter() {
    ...
    // This message no longer sounds corporate.
...
function surviveEncounter() {
    ...
    // Something suspicious after surviving

    setTimeout(
        () => {

            showToast(
                "NOTICE: REMOTE CONNECTION CLOSED"
            );
